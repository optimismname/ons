...
contract ReverseRegistrar {
    ...
    /**
     * @dev Constructor
     * @param ensAddr The address of the ONS registry.
     * @param resolverAddr The address of the default reverse resolver.
     */
    constructor(ONS onsAddr, NameResolver resolverAddr) public {
        ons = onsAddr;
     ...
     *      hexadecimal representation of an Optimism address.
     * @param addr The address to hash
